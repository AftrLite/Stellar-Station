...
public sealed class TraitorRuleTest
{
    ...
    public async Task TestTraitorObjectives()
    {
        ...
        Assert.That(client.AttachedEntity, Is.Not.Null); // EPHEMERAL SPACE
        ...
        // Assert.That(pair.Player?.AttachedEntity, Is.Null); // EPHEMERAL SPACE
        // Assert.That(dummies.All(x => x.AttachedEntity == null));  // EPHEMERAL SPACE
