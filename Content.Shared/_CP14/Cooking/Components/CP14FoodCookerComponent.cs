...
public sealed partial class CP14FoodCookerComponent : Component
{
    ...
    // [DataField]
    // public EntProtoId? BurntAdditionalSpawn = "SPREADABLE FIRE ENTITY GOES HERE";
    ...
    /// <summary>
    /// The method this cooker uses.
    /// </summary>
    [DataField]
    public CookingMethod CookMethod = CookingMethod.Temperature;

    /// <summary>
    /// Wether or not the cooker is powered. Required for CookMethod.Power.
    /// </summary>
    [DataField]
    public bool Powered = false;

    /// <summary>
    /// Wether or not this cooker can burn food.
    /// </summary>
    [DataField]
    public bool CanBurn = true;

    /// <summary>
    /// Wether or not this cooker can cook. Used by CookingMethod.Nested.
    /// </summary>
    [DataField]
    public bool NestedCooking = true;
...
// BEGIN - STELLAR STATION CHANGES (AftrLite)
[Serializable, NetSerializable]
public enum CookingMethod : byte
{
    /// <summary>
    /// Cooker is controlled by temperature (e.g. EntityHeater). The default behaviour.
    /// </summary>
    Temperature,
    /// <summary>
    /// Requires the cooker itself to be powered. (ApcPowerReceiver & such.)
    /// </summary>
    Power,
    /// <summary>
    /// The cooker can always cook, requiring nothing. (e.g. A bamboo mat for sushi)
    /// </summary>
    Innate,
    /// <summary>
    /// The cooker requires nesting inside the storage of an entity with CP14CookerRelayComponent.
    /// CookerRelay entities rely on power at current, though this could be further expanded on.
    /// </summary>
    Nested,
}
// END - STELLAR STATION CHANGES (AftrLite)
