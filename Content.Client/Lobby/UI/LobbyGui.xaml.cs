...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class LobbyGui : UIScreen
    {
        ...
        public LobbyGui()
        {
            ...
            RulesButton.OnPressed += _ => UserInterfaceManager.GetUIController<InfoUIController>().OpenWindow(); // Begin Stellar
            ...
            //ExpandButton.OnPressed += _ => TogglePanel(true); // End Stellar
        }
